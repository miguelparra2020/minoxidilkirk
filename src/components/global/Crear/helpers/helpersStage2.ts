export const colorOptionsTitles = [
    ...
    { name: "Gradiente Dorado", value: "gradient-gold", isGradient: true, gradientClass: "bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800" },
    ...
    { name: "Gradiente blue", value: "gradient-blue", isGradient: true, gradientClass: "bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800" },
